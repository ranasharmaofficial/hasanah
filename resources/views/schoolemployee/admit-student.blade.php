            ...
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('schoolemployee.view-student-details')}}" method="get" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group col-xs-12 mb-2">
                                <input type="text" class="form-control" required placeholder="Enter admission number" name="admissionno" id="admissionno" autocomplete="off" />
                            </div>
