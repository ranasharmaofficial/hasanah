                        ...
                        <div class="container">
                            <div class="row mb-3">
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control" required type="date" name="joining_date" placeholder="Joining Date" id="example">
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control" required type="text" name="experience" placeholder="Experience" id="Experience">
                                </div>
                            </div>
                        </div>
