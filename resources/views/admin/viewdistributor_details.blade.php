...
@section('title','View Distributor Details')
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                         <div class="dastone-profile">
                            <div class="row">
								<div class="col-lg-10 ms-auto align-self-center">
									<h4 class="text-danger text-center font-weight-bold">{{$companydata}}</h4>
                                </div>
								<div class="col-lg-2 text-right">
									<a href="{{url('admin/employee-list')}}" class="btn btn-primary btn-rounded"><i class="fa fa-angle-double-left"></i>&nbsp;Employee List</a>
                                </div>
