...
@section('title','Edit Distributor Details')
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form method="post" action="{{route('admin.updateDistributorDetails')}}" enctype="multipart/form-data" class="card-body">
                        @csrf
                        <h4 class="card-title font-weight-bold text-uppercase text-primary">Personal Details:-</h4><hr>
                        <input type="hidden" name="distributor_reg" value="{{ $employeedata->distributor_reg }}">
                        ...
                        <div class="container">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-select" type="text" name="experience" id="experience">
                        ...
                        <div class="container">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control" value="{{ $employeedata->pincode }}" type="tel" name="pin_code" placeholder="Enter Pin code" id="PinCode">
