            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header bg-danger rounded">
                        ...
                        <p class="p-0 m-0 text-white">Total Students: <b>{{$employeelists->total();}}</b>, Page No: <b>{{$employeelists->currentPage();}}</b></p>
                    </div>
                    <div class="card-body table-responsive">                        
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                            @foreach ($employeelists as $key => $data)
                            <tr>
                                <td>{{($employeelists->currentpage()-1) * $employeelists->perpage() + $key + 1}}</td>
                                <td>{{$data->user_id}}</td>
                                <td>{{$data->password}}</td>
                                <td>{{$data->name}}</td>
                                <td>{{$data->mobile}}</td>
