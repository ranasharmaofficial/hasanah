            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('uploadEmployeeData')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="container">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-12 text-center mt-3">
                                        <button name="add_employee" type="submit" class="btn btn-primary"><i class="fa fa-paper-plane"></i> Upload Employee Data</button>
                                    </div>
                                </div>                                
                            </div>                            
                        </form>
