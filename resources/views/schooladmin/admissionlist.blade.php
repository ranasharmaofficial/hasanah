            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header bg-danger rounded">
                        ...
                        <p class="p-0 m-0 text-white">Total Students: <b>{{$admissionlist->total();}}</b>, Page No: <b>{{$admissionlist->currentPage();}}</b></p>
                    </div>
                    <div class="card-body table-responsive">                        
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                            @foreach ($admissionlist as $key => $data)
                            <tr>
                                ...
                                <td><a href="{{url('schooladmin/admission-details/'.$data->id)}}"><button type="button" class="btn btn-info d-inline" title="View Details"><i class="fa fa-eye"></i></button>
