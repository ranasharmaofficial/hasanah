                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="POST" class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" value="" name="name" id="Project" required>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" multiple class="form-control" name="mobile" id="Mobile" required>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" multiple class="form-control" name="email" id="Email" required>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" multiple class="form-control" name="address" id="Address" required>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" multiple class="form-control" name="aadhar" id="Aadhar" required>
